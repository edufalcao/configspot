...
<template>
  <header class="sticky top-0 z-20 border-b border-[var(--color-border)] bg-[var(--color-bg)]/90 backdrop-blur-md">
    <div class="mx-auto flex h-14 max-w-7xl items-center justify-between px-6">
      <NuxtLink
        to="/"
        class="flex items-center gap-2 font-[var(--font-display)] text-lg font-semibold tracking-tight no-underline"
      >
      ...
      <div class="flex items-center gap-3">
        ...
        <a
          href="https://github.com/edufalcao/configspot"
          target="_blank"
